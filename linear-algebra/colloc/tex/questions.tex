...
\begin{proof}
	Положим для краткости $\phi_\l = \phi - \l\id$.
	...
	$(e_1, \ldots, e_{k_i})$ также был базисом в  $\ker\phi^{i}_\lambda = \phi - \lambda \id$. Тогда матрица ограничения $\phi_\l$ на $V^{\l}(\phi)$ в этом базисе имеет блочный вид:
	\begin{gather*}
